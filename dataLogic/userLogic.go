...
var CouldNotFindAccount help.Message = "Der Account konnte nicht gefunden werden"
var CouldFindAccount help.Message = "Der Account wurde gefunden"

func (acc *Account) GetUser(displayName string, username string, msg *help.Message, positiv *bool) {
	userLock.Lock()
...
var CouldNotChangeAccount help.Message = "Der Account konnte nicht geändert werden"
var CouldChangeAccount help.Message = "Der Account wurde geändert"
var AccountRetainsOrgs help.Message = "Account konnte nicht von allen Organisationen entfernt werden"
var AccountRetainsTitles help.Message = "Account konnte nicht von allen Titeln enfernt werden"

func (acc *Account) ChangeUser(msg *help.Message, positiv *bool) {
	userLock.Lock()
	defer userLock.Unlock()
...
var AccountCloudNotBeFound help.Message = "Dein Account konnte nicht gefunden werden"
var OldPasswordNotcorrect help.Message = "Das alte Password ist nicht korrekt"
var CouldNotHashPassword help.Message = "Das neue Passwort konnte nicht korrekt gehashed werden"
var AccountPasswordCouldNotBeSaved help.Message = "Es ist ein Fehler beim verändern des Passwords aufgetreten"
var AccountPasswordSuccessfulChanged help.Message = "Password erfolgreich angepasst"

func ChangePassword(displayName string, oldPassword string, newPassword string, msg *help.Message, positiv *bool) {
	userLock.Lock()
	defer userLock.Unlock()
