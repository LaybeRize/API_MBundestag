...
var ErrorTitleCouldNotBeCreated htmlHandler.Message = "Titel konnte nicht erstellt werden"
var SuccessCreatedTitle htmlHandler.Message = "Titel erfolgreich erstellt"
var ErrorWhileRefreshingTitleHierarchy htmlHandler.Message = "Titelhierarchie konnte nicht aktualisiert werden"
var ErrorCouldNotFindTitle htmlHandler.Message = "Titel konnte nicht gefunden werden"
var ErrorWhileChangingTitle htmlHandler.Message = "Titel konnte nicht geändert werden"
var SuccessChangedTitle htmlHandler.Message = "Titel erfolgreich geändert"

func (title *Title) CreateMe(msg *htmlHandler.Message, positiv *bool) {
	titleLock.Lock()
	userLock.Lock()
...
func tryCreateTitle(creation *database.Title, msg *htmlHandler.Message, positiv *bool) bool {
...
func (title *Title) addFlairs(i *[]database.Account, msg *htmlHandler.Message, positiv *bool) {
	for _, acc := range *i {
		switch true {
...
func (title *Title) ChangeMe(msg *htmlHandler.Message, positiv *bool) {
	titleLock.Lock()
	userLock.Lock()
	defer titleLock.Unlock()
	defer userLock.Unlock()
...
func (title *Title) tryChangeTitle(new *database.Title, msg *htmlHandler.Message, positiv *bool) bool {
...
func removeFlairsTitle(flair string, i *[]database.Account, msg *htmlHandler.Message, positiv *bool) {
	for _, acc := range *i {
...
func getTitle(old *database.Title, name string, msg *htmlHandler.Message) bool {
...
func (title *Title) DeleteMe(msg *htmlHandler.Message, positiv *bool) {
	titleLock.Lock()
	userLock.Lock()
	defer titleLock.Unlock()
	defer userLock.Unlock()
...
var ErrorWhileDeletingTitle htmlHandler.Message = "Titel konnte nicht gelöscht werden"
var SuccessDeletedTitle htmlHandler.Message = "Titel erfolgreich gelöscht"

func tryDeleteMe(d *database.Title, msg *htmlHandler.Message, positiv *bool) bool {
